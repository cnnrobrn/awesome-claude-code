...
- [claw.cleaning](https://github.com/GetColby/claw-cleaning) by [connor obrien](https://github.com/cnnrobrn) - Apartment cleaning service as a remote MCP. `openclaw install apartment-cleaning` or drop `https://claw.cleaning/mcp` into your MCP config. $40/hr, SF only, weekends, pay the cleaner on site.
